 ...
 *
 * @author yangjun
 * @version $Id: Pager.java, v 0.1 2012-4-19 上午9:38:48 yangjun Exp $
 */
public class Pager implements Serializable {
	...
	public String toString() {
		...
		sb.append("    Showing items ").append(getBeginIndex()).append(" to ").append(getEndIndex()).append(" (total ").append(getItemsTotal()).append(" items), ");
